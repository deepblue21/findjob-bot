# 🤖 JOB_BOT — Çok Profilli Kişisel İş Arama Botu + Dashboard

Birden fazla CV/kişi için **Türkiye bazlı** iş ilanlarını otomatik tarayan, becerilere göre
puanlayan, **Telegram'a bildiren** ve terminal temalı bir **web dashboard**'da yöneten araç.

Kaynaklar: **Kariyer.net · Indeed · Google Jobs · LinkedIn** (uluslararası remote feed'ler opsiyonel/kapalı).

> Kişisel kullanım içindir. Bot otomatik **başvuru yapmaz** — yalnızca ilan bulur, puanlar,
...
- **CV'ye göre puanlama:** profildeki beceriler puanlamaya otomatik eklenir; ilanlar gerçek uyuma göre sıralanır.
- **Konum filtresi:** sadece izin verilen şehirler (ör. İzmir/Manisa, yerinde+hibrit) **veya** tamamen uzaktan; diğer şehirlerin yerinde ilanları elenir.
...
- **Telegram:** eşleşen ilanları kişi adıyla bildirir; tarama bitince **özet rapor** gönderir.
...
> Windows'ta **WSL2 (Ubuntu)** önerilir. Python 3.10+ gerekir.
...
# 5) (Önerilen) doğrula — Telegram'a test mesajı atar
python selftest.py
...
- `scoring` — ortak puanlama (konum/çalışma şekli/seviye)
...
Bu araç kişisel kullanım içindir. LinkedIn/Kariyer.net gibi sitelerin kullanım şartlarına
